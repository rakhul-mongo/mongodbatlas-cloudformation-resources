...
## Step 2: Create template using [backup-compliance-policy.json](backup-compliance-policy.json)
...
10. Policy items (OnDemand, Hourly, Daily, Weekly, Monthly, Yearly) (optional)

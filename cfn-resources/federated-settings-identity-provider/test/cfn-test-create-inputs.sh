...
function usage {
	...
	echo ""
	echo "Federation Settings ID is required and can be provided via:"
	echo "  1. MONGODB_ATLAS_FEDERATION_SETTINGS_ID environment variable (recommended)"
	echo "  2. Command line argument (must be valid 24-char hex ID)"
	exit 0
}
...
# Priority: 1. Env var (recommended), 2. Argument (must be valid 24-char hex ID)
